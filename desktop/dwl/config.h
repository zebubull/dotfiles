...
static const char *cursor_theme            = "Vimix-cursors";
...
static const PassKeypressRule pass_rules[] = {
	ADDPASSRULE("discord", 0, XKB_KEY_Shift_R),
	ADDPASSRULE("discord", 0, XKB_KEY_Control_R),
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_g,          togglefullscreen, {0} },
